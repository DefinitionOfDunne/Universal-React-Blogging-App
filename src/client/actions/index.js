...
export const API_URL = location.href.indexOf('localhost') > 0 ? 'http://localhost:8080/api' : '/api';
export const CLIENT_ROOT_URL = location.href.indexOf('localhost') > 0 ? 'http://localhost:8080' : '/';
